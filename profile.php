        ...
        <header class="profile__header">
            ...
            <div class="profile__column">
                ...
                <p class="profile__bio">
                    ...
                    </span> <?php echo $_SESSION['profile']['bio']; ?>
                    <a href="https://www.wikipedia.org/" target="_blank"><?php echo $_SESSION['profile']['web']; ?></a>
                </p>
            </div>
        </header>
        <section class="profile__photos">
        <?php
            $query = mysqli_query($conn, "SELECT image FROM photo WHERE url = 'url'");
