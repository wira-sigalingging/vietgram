...
<body>
    ...
    <main id="feed">
        <?php
            if (array_key_exists("caption", $_GET)) {
                $query = mysqli_query($conn, 'SELECT * FROM photo WHERE caption LIKE "%' . $_GET["caption"] . '%" ');
            } else {
        ...
        ?>
            <div class="photo">
                <header class="photo__header">
                    <img src="images/profil2.jpg" class="photo__avatar" />
                    <div class="photo__user-info">
                        <span class="photo__author">wirasiga<?php echo $_SESSION['user']['username']; ?></span>
                ...
                <div class="photo__info">
                    ...
                    <span class="photo__likes">5000 likes</span>
